...
export const teamArray: AboutProp[] = [
  ...
  },
  {
    ...
    bio: '',
    socialLinks: [
      { platform: 'linkedIn', url: 'https://linkedin.com/in/edafemerit' },
    ],
  ...
  },
  {
    ...
    socialLinks: [
      {
        platform: 'linkedIn',
        url: 'https://www.linkedin.com/in/kingsley-oghuanlan-a329111a4',
      },
  ...
  },
  {
    ...
    socialLinks: [
      {
        platform: 'linkedIn',
        url: 'https://www.linkedin.com/in/gbenga-balogun-68500119a',
      },
